...
export default function Center_left() {
  return (
    <div className='w-2/3 flex flex-col'>
      <h1 className='text-6xl pl-36 pt-36'>Empowering <GiTakeMyMoney className='inline'/> Your Financial  Freedom.</h1>
      ...
      <input className=' bg-gray-900 h-full w-full rounded-2xl text-xl pl-5' placeholder='enter email'/>
      </div>
      </div>
    </div>
  )
