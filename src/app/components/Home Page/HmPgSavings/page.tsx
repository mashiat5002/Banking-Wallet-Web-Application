  ...
  return (
    <div className="h-11/12 w-11/12  bg-logo-surrounding text-custom-white rounded-2xl ">
      <div className="w-full h-1/5   flex">
            ...
            <Dialog_form_sectors_change/>
            </div>
      </div>

        
        <SavingsList data={{balance:balance.balance1, target:target.target1 ,sector:sectors.sector1, dept: "department_1_target", percentage: percentage.percentage_1.toPrecision(2)}}/>
        <SavingsList data={{balance:balance.balance2, target:target.target2 ,sector:sectors.sector2, dept: "department_2_target", percentage: percentage.percentage_2.toPrecision(2)}}/>
