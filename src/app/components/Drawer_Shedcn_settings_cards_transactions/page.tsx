...
const Drawer_Shedcn_settings_cards_transactions: React.FC<props>=({action ,setStatus,heading, description})=> {
    const data = [
        {
          goal: 400,
        },
 ...
 const headlines= ["Last 6 Months", "Last 7 Days", "Last 7 weeks","Last 6 Active Months", "Last 7 Active Days", "Last 7 Active Weeks"]
  ...
  return (
    <div className='h-full cursor-pointer '>
     <Drawer>
      <DrawerTrigger asChild className='h-full  text-xs mr-5'>
...
export default Drawer_Shedcn_settings_cards_transactions;